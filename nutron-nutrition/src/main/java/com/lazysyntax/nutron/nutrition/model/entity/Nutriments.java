...
public class Nutriments {
    ...
    public Nutriments(String quantity, String quantityUnit, Double calories, Double proteins, Double carbs, Double fat, Double saturatedFat, Double sugars, Double salt) {
